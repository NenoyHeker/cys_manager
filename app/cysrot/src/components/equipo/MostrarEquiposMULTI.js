...
import {EquipoIndividual} from "./EquipoIndMULTI";

export const MostrarEquiposMULTI = () => {
...
// "<ClienteIndividual cliente = {}>" renderiza el componene ClienteInd y se le manda como parametro cliente 
    const listarEquiposMULTI = dataEquipo.map((equipo, id) =>{
        return(
            <div key={id}>   
        ...
        <div className="container-fluid">
            <div className='container mt-5 mb-5 '>
                <div className="row">
                    ...
                    <div className='col-md'>Contador</div>
